const SalePercentage = () => {
    return (
        <div className="mb-24">
            ...
            <section className="mx-8 p-3 py-8 my-6 bg-gray-800 text-gray-100">
                <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2  xl:grid-cols-4 py-8">

                <div className="flex border-2 border-violet-400 border-dotted hover:bg-[rgba(2,3,5,0.67)] shadow-md rounded-tr-full   shadow-slate-300 p-4 space-x-4 rounded-lg md:space-x-6 bg-gray-950 text-gray-100">
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-violet-400 shadow-md shadow-gray-100">
                        ...
                        <div className="flex flex-col justify-center align-middle">
                            <p className="text-3xl font-bold leadi">7500</p>
                            <p className="capitalize font-semibold">New customers</p>
                        </div>
                    </div>
                    <div className="flex justify-end align-middle hover:bg-[rgba(2,3,5,0.67)] border-2 rounded-tl-full border-dotted border-violet-400 shadow-md shadow-slate-300 p-4 pb-2 space-x-4 rounded-lg md:space-x-6 bg-gray-950 text-gray-100">

                        <div className="flex flex-col justify-center align-middle">
                            <p className="text-3xl font-bold leadi">172%</p>
                    ...
                    <div className="flex rounded-br-full hover:bg-[rgba(2,3,5,0.67)] border-2 border-violet-400 shadow-md rounded- shadow-slate-300  pb-2 p-10 space-x-4 rounded-lg md:space-x-6 bg-gray-900 text-gray-100">
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-violet-400">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="h-9 w-9 text-gray-800">
                    ...
                    <div className="flex justify-end align-middle rounded-bl-full  border-2 border-violet-400 shadow-md rounded- hover:bg-[rgba(2,3,5,0.67)]  shadow-slate-300 p-10 pb-2 space-x-4 rounded-lg md:space-x-6 bg-gray-900 text-gray-100">
                    <div className="flex flex-col justify-center align-middle">
                            <p className="text-3xl font-semibold leadi">17%</p>
                            <p className="capitalize">Bounce rate</p>
                        </div>
                        <div className="flex justify-end p-2 pr-0 align-middle rounded-lg sm:p-4 bg-violet-400">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="h-9 w-9 text-gray-800">
            ...
            <section className="mx-8 p-2 my-6 md:p-8 bg-gray-800 text-gray-100">
                <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
                    <div className="flex hover:bg-[rgba(2,3,5,0.67)] shadow-md hover:shadow-slate-300 overflow-hidden rounded-lg bg-gray-900 text-gray-100">
                        <div className="flex items-center justify-center px-4 text-gray-800 bg-violet-400">
                    ...
                    <div className="flex overflow-hidden rounded-lg shadow-md shadow-slate-300 bg-gray-950 text-gray-100">
                    ...
                    <div className="flex hover:bg-[rgba(2,3,5,0.67)] shadow-md hover:shadow-slate-300  overflow-hidden rounded-lg bg-gray-900 dark:text-gray-100">
                        <div className="flex items-center justify-center px-4 bg-violet-400 text-gray-800">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-6 h-6">
                    ...
                    <div className="flex hover:bg-[rgba(2,3,5,0.67)] shadow-md shadow-slate-300  overflow-hidden rounded-lg bg-gray-950 text-gray-100">
                        <div className="flex items-center justify-center px-4 bg-violet-400 text-gray-800">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-6 h-6">
