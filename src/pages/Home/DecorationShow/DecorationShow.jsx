...
const DecorationShow = () => {
	...
	<div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
		<img src="https://i.ibb.co/dKwnYw2/home2.png" alt="" className="w-full h-60 sm:h-96 dark:bg-gray-500" />
		<div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md dark:bg-gray-900">
			...
			<div className="dark:text-gray-100">
				<p>Join us at our Decoration Show! Witness stunning displays, get inspired, and discover the latest trends. Dont miss out on this opportunity to elevate your space. See you there!...</p>
			</div>
		</div>
	</div>
</div>
