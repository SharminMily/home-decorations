            ...
            <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-gray-800 text-gray-100">
                <div className="flex flex-col justify-between ">
                    <div className="space-y-2">
                        ...
                        <div className="text-gray-400 pb-6 text-center ">Vivamus in nisl metus? Phasellus.</div>
                    </div>
                    <img src="https://i.ibb.co/1J8Mzkv/privacy-policy.gif" alt="login-image" className="w-full flex justify-start pr-8 items-center" />
                </div>
                ...
                <div className="border border-violet-700  rounded-xl shadow-xl shadow-slate-500 p-8">
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 mb-10">
                        ...
                        <button type="submit" className="w-full p-3  text-sm font-bold uppercase rounded bg-violet-400 text-gray-900">Sign in</button>
                    </form>
